...
class PlantGrowthPredictor {
    ...
    public function __construct() {
        $this->data = [
            ...
            'LeafCount' => [2.024, 3.498, 3.966, 2.197, 3.435, 4.187],
            'Survivability' => [98.56, 98.56, 96.39, 100, 98, 98],
            'Chlorophyll' => [null, 0.524, 0.409, null, 0.514, 0.434] // No data for week 1
        ];
    }
