...
class PlantGrowthPredictor {
    ...
    public function __construct() {
        $this->data = [
            ...
            'LeafCount' => [1.9, 2.954, 2.367, 1.967, 3.471, 4.026],
            'Survivability' => [95.24, 96.19, 70.24, 99.05, 100, 98.57],
            'Chlorophyll' => [null, 0.538, 0.447, null, 0.550, 0.411] // No data for week 1
        ];
    }
